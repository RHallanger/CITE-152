    ...
    for device_name, device_info in devices.items():
        ...
        if device_info["ip"] == target_device_ip:
            ...
            if device_name == "Router 1":  # No password required for Router 1 (default gateway)
                # Allow connection without password if no password is entered
                if password == "":
            ...
            # If the device is not Router 1, check the password
            ...
            if required_password:
                ...
                print(f"No password required for {device_name}, but none provided.")
                return None
